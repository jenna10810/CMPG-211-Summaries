...
\begin{center}
    \begin{tabular}{| 
        ...
        \hline
        3 & \text{\mintinline{java}{result = 0}} & $\tau_{\text{fetch}} + \tau_{\text{store}}$\\
        4a &  \text{\mintinline{java}{i = 1}} & $\tau_{\text{fetch}} + \tau_{\text{store}}$\\
        4b & \text{\mintinline{java}{i <= n}} & $(n+1)(2\tau_{\text{fetch}} + \tau_{\text{store}})$\\
        4c & \text{\mintinline{java}{++i}} & $(n)(2\tau_{\text{fetch}} + \tau_{<} + \tau_{\text{store}})$\\
        5 & \text{\mintinline{java}{result += i}} & $(n)(2\tau_{\text{fetch}} + \tau_{<} + \tau_{\text{store}})$\\
        6 & \text{\mintinline{java}{return result}} & $\tau_{\text{fetch}} + \tau_{\text{return}}$\\
        \hline
        \hline
...
\begin{center}
    \begin{tabular}{| 
        ...
        \hline
        \multicolumn{1}{|>{\columncolor{Periwinkle!30}}c|}{\textbf{statement}} & \multicolumn{1}{>{\columncolor{Periwinkle!30}}c|}{\textbf{code}} & \multicolumn{1}{>{\columncolor{Periwinkle!30}}c|}{\textbf{time}}\\
        3 & \text{\mintinline{java}{int result = a[n]}} & $3\tau_{\text{fetch}} + \tau_{[\cdot]} + \tau_{\text{store}}$\\
        4a & \text{\mintinline{java}{int i = n - 1}} & $2\tau_{\text{fetch}} + \tau_{-} + \tau_{\text{store}}$\\
        4b & \text{\mintinline{java}{i >= 0}} & $(n+1)(2\tau_{\text{fetch}} + \tau_{<})$\\
        4c & \text{\mintinline{java}{--i}} & $(n)(2\tau_{\text{fetch}} + \tau_{-} + \tau_{\text{store}})$\\
        5 & \text{\mintinline{java}{result = result * x + a[i]}} & $(n)(5\tau_{\text{fetch}} + \tau_{[\cdot]} + \tau_{+} + \tau_{\times} + \tau_{\text{store}})$\\
        6 & \text{\mintinline{java}{return result}} & $\tau_{\text{fetch}} + \tau_{\text{store}}$\\
        \hline \hline
...
\begin{center}
    \begin{tabular}{
        |>{\columncolor{Periwinkle!10}} L{3cm} | 
        >{\columncolor{Periwinkle!10}} l |
        >{\columncolor{Periwinkle!10}} l |}
        \hline
        \multicolumn{1}{|>{\columncolor{Periwinkle!30}}c|}{\textbf{\# of times the b-part executes}} & \multicolumn{1}{>{\columncolor{Periwinkle!30}}c|}{\textbf{\# of times the c-part executes}} &
        \multicolumn{1}{>{\columncolor{Periwinkle!30}}c|}{\textbf{notes}}\\
        \hline
        \makecell{more than \textbf{c}:\\$n+1$ times}
    \end{tabular}
\end{center}
